...
<div class="br-pagetitle">
    ...
    <div>
      <h4>Client Page</h4>
      <p class="mg-b-0">Manage Client</p>
    </div>
</div>
              ...
              @php $sl=1 @endphp
                @foreach ($clientmanage as $data)
                  <tr>
                    ...
                    <td>
                      <a href="{{route('clientedit',$data->id)}}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="{{route('clientdelete', $data->id )}}" class="btn btn-danger">Confirm</a>
      </div>
    </div>
  </div>
</div>
