    ...
    <div class="br-header">
      ...
      <div class="br-header-right">
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{asset('frontend/img/3.png')}}" class="wd-32 rounded-circle" alt="">
              <span class="square-10 bg-success"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href=""><img src="{{asset('frontend/img/3.png')}}" class="wd-80 rounded-circle" alt=""></a>
        ...
        <div class="navicon-right">
          <a href="{{route('contactmanage')}}" class=" pos-relative" >
