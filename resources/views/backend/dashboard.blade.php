...
<div class="br-pagetitle">
        ...
        <div>
          <h4>Dashboard</h4>
          <p class="mg-b-0">Friends construction site.</p>
        </div>
      </div>
        ...
        <div class="row row-sm">
          <div class="col-sm-6 col-xl-3">
            <div class="bg-info rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                <i class="fas fa-user tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Admin Request</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{$admincount}}</p>
                  <span><a  style="color:white; "href="{{route('adminmanage')}}">view details</a></span>
                </div>
              </div>
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
            <div class="bg-purple rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                <i class="fas fa-project-diagram tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="bg-teal rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                <i class="fas fa-wrench tx-60 lh-0 tx-white op-7"></i> 
                <div class="mg-l-20">
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="bg-primary rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                <i class="icon ion-ios-email-outline tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Message</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{$messagecount}}</p>
                  <span><a  style="color:white; "href="{{route('contactmanage')}}">view details</a></span>
                </div>
              </div>
